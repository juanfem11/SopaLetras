...
function WordSearchController(gameId, listId, solveId, newGameId, instructionsId, themeId) {
	...
	var searchTypes = {
		...
		"Programacion Web": [["JavaScript", "HTML", "CSS", "VisualStudio"],
			...
			["GitHub", "Git", "Bernardo", "Figma"],
			["href", "Class", "Background", "Padding"],
			["Margin",  "width",  "UTF", "IUE"]],
	...
	var mainInstructions = "Selecciona una letra y arrastra para completar la palabra";
